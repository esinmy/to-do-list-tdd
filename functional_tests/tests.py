...
class NewVisitorTest(LiveServerTestCase):
    ...
    def _test_can_start_a_list_for_one_user(self):
        ...
        # She is inveted to enter a to-do item straight away
    ...
    def _test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # He is less interesing than Edith
        inputbox = self.browser.find_element_by_id("id_new_item")
